...
export default function Footer() {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      addToast(result.error || t("subError"), "error");
    }
  };
      ...
      <div className="container mx-auto px-8">
        ...
        <div className="pt-8 border-t border-[#8A95A5]/20 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/pelincelik444/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-[#2A303A] flex items-center justify-center text-[#8A95A5] hover:bg-[#C61A1A] hover:text-white transition-all">
            ...
            <a href="https://www.linkedin.com/in/pelin-celik-84644a5/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-[#2A303A] flex items-center justify-center text-[#8A95A5] hover:bg-[#C61A1A] hover:text-white transition-all">

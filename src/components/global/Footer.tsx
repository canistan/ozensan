      ...
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li><Link href="/blog" className="hover:text-[#C61A1A] transition-colors text-sm font-medium">Endüstri Blogu</Link></li>
        ...
        <div className="pt-8 border-t border-[#8A95A5]/20 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            <Link href="#" className="w-8 h-8 rounded-full bg-[#2A303A] flex items-center justify-center text-[#8A95A5] hover:bg-[#C61A1A] hover:text-white transition-all">

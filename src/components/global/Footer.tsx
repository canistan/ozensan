      ...
      <footer className="bg-[#101317] text-white pt-20 pb-10 border-t-4 border-[#C61A1A]">
        ...
        <div className="pt-8 border-t border-[#8A95A5]/20 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-3 justify-center md:justify-start">
            <a href="https://www.instagram.com/ozensan.as/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-[#2A303A] flex items-center justify-center text-[#8A95A5] hover:bg-[#C61A1A] hover:text-white transition-all">
            ...
            <a href="https://www.linkedin.com/company/ozensan-a-s/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-[#2A303A] flex items-center justify-center text-[#8A95A5] hover:bg-[#C61A1A] hover:text-white transition-all">

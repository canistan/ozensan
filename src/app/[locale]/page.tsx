        ...
        <div className="container mx-auto px-8 relative z-20">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <a href="https://wa.me/905305671116" target="_blank" rel="noopener noreferrer" className="bg-transparent border-2 border-[#8A95A5] text-[#8A95A5] hover:bg-[#25D366] hover:border-[#25D366] hover:text-white text-base font-black px-10 sm:px-6 py-5 uppercase tracking-widest rounded-sm transition-all flex items-center justify-center gap-3">

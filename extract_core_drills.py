...
with open("core_drills_urls.json", "r") as f:
    urls = json.load(f)

temp_dir = "public/temp_core_drills"
os.makedirs(temp_dir, exist_ok=True)

raw_products = []

print(f"Starting to scrape {len(urls)} core drills...")
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=15) as response:
            ...
            if specs_div:
                for li in specs_div.find_all('li'):
                    ...
                    if h6 and p:
                        ...
                        specs_en.append({"param": param_en, "value": val, "accessory": "-"})
                        specs_tr.append({"param": translate_text(param_en), "value": val, "accessory": "-"})
            ...
            raw_products.append({
                ...
                "name": title_tr,
                "nameEn": title_en,
                "image": local_image_path,  # temporary local path, will be updated by node script
                "description": desc_tr,
                ...
                "solutions": ["profesyonel-delme-ve-kirim"],
                "isFeatured": False
            })
...
with open("raw_core_drills.json", "w", encoding="utf-8") as f:
    json.dump(raw_products, f, ensure_ascii=False, indent=2)

print("Scraping and translation completed to raw_core_drills.json")

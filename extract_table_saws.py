...
with open("table_saws_urls.json", "r") as f:
    urls = json.load(f)

temp_dir = "public/temp_table_saws"
os.makedirs(temp_dir, exist_ok=True)

raw_products = []

print(f"Starting to scrape {len(urls)} table saws...")
...
with open("raw_table_saws.json", "w", encoding="utf-8") as f:
    json.dump(raw_products, f, ensure_ascii=False, indent=2)

print("Scraping and translation completed to raw_table_saws.json")

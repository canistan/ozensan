...
with open("duss_combi_urls.json", "r") as f:
    urls = json.load(f)

temp_dir = "public/temp_duss_combi"
os.makedirs(temp_dir, exist_ok=True)

raw_products = []
print(f"Starting to scrape {len(urls)} DUSS Combi Hammers...")
...
with open("raw_duss_combi.json", "w", encoding="utf-8") as f:
    json.dump(raw_products, f, ensure_ascii=False, indent=2)

print("Scraping and translation completed to raw_duss_combi.json")

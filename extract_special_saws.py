...
with open("special_saws_urls.json", "r") as f:
    urls = json.load(f)

temp_dir = "public/temp_special_saws"
os.makedirs(temp_dir, exist_ok=True)

raw_products = []

print(f"Starting to scrape {len(urls)} special machines...")
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=15) as response:
            ...
            raw_products.append({
                ...
                # Assign to both Road Construction and Heavy Industry since they are special machines
                "solutions": ["yol-yapim-ve-bakim", "agir-sanayi-ve-metal"],
                "isFeatured": False
            })
...
with open("raw_special_saws.json", "w", encoding="utf-8") as f:
    json.dump(raw_products, f, ensure_ascii=False, indent=2)

print("Scraping and translation completed to raw_special_saws.json")

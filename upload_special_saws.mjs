...
const rawSawsPath = path.join(process.cwd(), 'raw_special_saws.json');
const tempDir = path.join(process.cwd(), 'public/temp_special_saws');

async function processSpecial() {
    console.log("Reading raw_special_saws.json...");

...
const rawSawsPath = path.join(process.cwd(), 'raw_duss_chiselling.json');
const tempDir = path.join(process.cwd(), 'public/temp_duss_chiselling');

async function processDuss() {
    console.log("Reading raw_duss_chiselling.json...");

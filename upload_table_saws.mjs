...
// GÜVENLİK YASASI UYGULANDI: Şifre koda yazılmıyor, doğrudan çevresel değişkenlerden okunuyor!
// Eğer process.env.BLOB_READ_WRITE_TOKEN yoksa dotenv kullanarak .env dosyasını oku.
...
const rawSawsPath = path.join(process.cwd(), 'raw_table_saws.json');
const tempDir = path.join(process.cwd(), 'public/temp_table_saws');

async function processTableSaws() {
    console.log("Reading raw_table_saws.json...");

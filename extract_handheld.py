        ...
        with urllib.request.urlopen(req, timeout=15) as response:
            ...
            for a in soup.find_all('a', href=True):
                if '/products/details/' in a['href']:
                    urls.append(urllib.parse.urljoin("https://www.cedima.com", a['href']))
    except:
        pass

urls = list(set(urls))
print(f"Found {len(urls)} hand-held accessories.")

temp_dir = "public/temp_handheld"
        ...
        with urllib.request.urlopen(req, timeout=15) as response:
            ...
            if slider:
                ...
                if first_img:
                    ...
                    img_req = urllib.request.Request(fixed_url, headers=headers)
...
with open("raw_handheld.json", "w", encoding="utf-8") as f:
    json.dump(raw_products, f, ensure_ascii=False, indent=2)

print("Scraping and translation completed to raw_handheld.json")

...
const rawSawsPath = path.join(process.cwd(), 'raw_duss_core.json');
const tempDir = path.join(process.cwd(), 'public/temp_duss_core');

async function processDuss() {
    console.log("Reading raw_duss_core.json...");

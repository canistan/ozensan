...
with open("duss_accessories_urls.json", "r") as f:
    urls = json.load(f)

temp_dir = "public/temp_duss_accessories"
os.makedirs(temp_dir, exist_ok=True)

raw_products = []
print(f"Starting to scrape {len(urls)} DUSS Tools and Accessories...")
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=15) as response:
            ...
            raw_products.append({
                ...
                "solutions": ["elmas-uclar-ve-diskler"], 
                "isFeatured": False
            })
...
with open("raw_duss_accessories.json", "w", encoding="utf-8") as f:
    json.dump(raw_products, f, ensure_ascii=False, indent=2)

print("Scraping and translation completed to raw_duss_accessories.json")

...
const rawSawsPath = path.join(process.cwd(), 'raw_duss_drilling.json');
const tempDir = path.join(process.cwd(), 'public/temp_duss_drilling');

async function processDuss() {
    console.log("Reading raw_duss_drilling.json...");

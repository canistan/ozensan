...
const rawSawsPath = path.join(process.cwd(), 'raw_duss_combi.json');
const tempDir = path.join(process.cwd(), 'public/temp_duss_combi');

async function processDuss() {
    console.log("Reading raw_duss_combi.json...");

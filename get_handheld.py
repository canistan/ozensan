...
url = "https://www.cedima.com/en/applications/hand-held-tools.html"
...
try:
    with urllib.request.urlopen(req, timeout=15) as response:
        ...
        for a in links:
            ...
            if 'hand-held-tools' in href and len(a.get_text(strip=True)) > 2:
                full_url = urllib.parse.urljoin("https://www.cedima.com", href)
                products.add((a.get_text(strip=True), full_url))
                
        print(f"Found internal links in Hand-held Tools:")

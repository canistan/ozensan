...
const rawSawsPath = path.join(process.cwd(), 'raw_wall_saws.json');
const tempDir = path.join(process.cwd(), 'public/temp_wall_saws');

async function processWallSaws() {
    console.log("Reading raw_wall_saws.json...");

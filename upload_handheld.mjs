...
const rawSawsPath = path.join(process.cwd(), 'raw_handheld.json');
const tempDir = path.join(process.cwd(), 'public/temp_handheld');

async function processHandheld() {
    console.log("Reading raw_handheld.json...");

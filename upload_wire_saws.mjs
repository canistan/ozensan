...
const rawSawsPath = path.join(process.cwd(), 'raw_wire_saws.json');
const tempDir = path.join(process.cwd(), 'public/temp_wire_saws');

async function processWireSaws() {
    console.log("Reading raw_wire_saws.json...");

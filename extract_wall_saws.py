...
with open("wall_saws_urls.json", "r") as f:
    urls = json.load(f)

temp_dir = "public/temp_wall_saws"
os.makedirs(temp_dir, exist_ok=True)

raw_products = []

print(f"Starting to scrape {len(urls)} wall saws...")
...
with open("raw_wall_saws.json", "w", encoding="utf-8") as f:
    json.dump(raw_products, f, ensure_ascii=False, indent=2)

print("Scraping and translation completed to raw_wall_saws.json")
